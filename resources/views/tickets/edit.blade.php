        ...
        <div class="row g-0 shadow-lg rounded-4 overflow-hidden border bg-white" style="min-height: 85vh;">
            ...
            <div class="col-md-5 bg-light p-5 d-flex flex-column border-end position-relative">
                <div class="mb-auto">
                    ...
                    <p class="text-muted">Memperbarui rincian untuk tiket #{{ $ticket->id }}</p>

                    <div class="mt-5">
                        <div class="p-4 rounded-4 bg-white shadow-sm border mb-3">
                            <label class="small fw-bold text-muted d-block mb-2 uppercase letter-spacing-1">STATUS SAAT
                                INI</label>
                        ...
                        <div class="p-4 rounded-4 bg-white shadow-sm border mb-3">
                            <label class="small fw-bold text-muted d-block mb-1 uppercase letter-spacing-1">DETAIL
                                PEMBUATAN</label>
                            <p class="small mb-1 text-dark">Oleh: <strong>{{ $ticket->user->name ?? 'System' }}</strong></p>
                            <p class="small mb-0 text-muted">{{ $ticket->created_at->format('d M Y, H:i') }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="d-flex gap-3">
                                <button type="submit"
                                    class="btn btn-primary btn-lg px-5 py-3 shadow-lg border-0 flex-grow-1">
                                    <i class="bi bi-save me-2"></i>Simpan Perubahan
                                </button>
                                <button type="reset" class="btn btn-light border btn-lg px-4 py-3">
